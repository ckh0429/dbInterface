...
public class PostTableFunction extends ServerTableAttribute {
    ...
    public static boolean create(String dbName) {
        try {
            ...
            String sql = "CREATE TABLE if not exists " + POST_TABLE + "(" + POST_ID
                    + " INTEGER PRIMARY KEY AUTOINCREMENT, " + POST_FROM_WHO + " CHAR(20) NOT NULL, " + POST_TO_WHO
                    + " CHAR(20) NOT NULL, " + POST_SUBJECT + " TEXT, " + POST_CONTENT + " TEXT, " + POST_TIME
                    + " CHAR(20) NOT NULL, " + POST_READ_STATUS + " TEXT " + ")";
    ...
    public static boolean insert(JSONArray rawData) {
        ...
        ArrayList<String> postTime = new ArrayList<String>();
        ...
        for (int i = 0; i < rawData.size(); i++) {
            ...
            postTime.add(jobj.get(POST_TIME).toString());
